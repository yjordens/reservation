...
create table WAGEN_ONTVANGST (
    ...
    constraint PK_WAGEN_ONTVANGST primary key (id),
...
create index I_FK01_WAGEN_ONTVANGST on WAGEN_ONTVANGST(creatieGebruiker_id);
create index I_FK02_WAGEN_ONTVANGST on WAGEN_ONTVANGST(wijzigingsGebruiker_id);
create index I_FK03_WAGEN_ONTVANGST on WAGEN_ONTVANGST(reserveerder_id);
...
create index I_FK01_RESERVATIE on RESERVATIE(creatieGebruiker_id);
create index I_FK02_RESERVATIE on RESERVATIE(wijzigingsGebruiker_id);
create index I_FK03_RESERVATIE on RESERVATIE(wagen_id);
create index I_FK04_RESERVATIE on RESERVATIE(annulatieGebruikerId);
