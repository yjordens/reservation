...
CREATE TABLE nvpair (
    ...
    constraint PK_nvpair primary key (id) using index tablespace pg_default,
...
create index I_FK01_NVPAIR on nvpair(creatieGebruiker_id) tablespace pg_default;
create index I_FK02_NVPAIR on nvpair(wijzigingsGebruiker_id) tablespace pg_default;
