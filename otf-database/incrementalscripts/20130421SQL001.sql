...
create table WAGEN (
    ...
    constraint PK_WAGEN primary key (id) using index tablespace pg_default,
...
create index I_FK01_WAGEN on WAGEN(creatieGebruiker_id) tablespace pg_default;
create index I_FK02_WAGEN on WAGEN(wijzigingsGebruiker_id) tablespace pg_default;
